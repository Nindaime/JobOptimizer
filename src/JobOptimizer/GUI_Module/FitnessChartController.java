 ...
 */
package JobOptimizer.GUI_Module;

import JobOptimizer.JobOptimizer;
//import JobOptimizer.GA_on_JAP.TCP;
import JobOptimizer.GA_on_JAP.JobOptimizer;
import java.net.URL;
...
public class FitnessChartController implements Initializable, ControlledScreen{
    ...
    private void closeButtonAction(ActionEvent event) {
        ...
        JobOptimizer.playCurrentAnimation(mainPageRoot, container);
    ...
    public static void loadData(){
        ...
        for(JobOptimizer t: JobOptimizer.gBests){
            ...
            System.out.println("loaded data"+JobOptimizer.gBests.indexOf(t));
        }
    }
