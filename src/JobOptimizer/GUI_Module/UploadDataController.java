 ...
 * @author USER-PC
 */
public class UploadDataController implements Initializable, ControlledScreen  {
    ...
    private static void configureFileChooser(final FileChooser fileChooser) {
        ...
        fileChooser.setInitialDirectory(new File(JobOptimizer.workingDirectory+"/Documents/"));
